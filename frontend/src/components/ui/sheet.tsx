...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/95 backdrop-blur-2xl border-border/60 shadow-elevated transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-left p-6 border-b border-border/60",
      className
    )}
    {...props}
  />
